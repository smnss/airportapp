...
var map = {
	"./features/airport/airport.module": [
		"./src/app/features/airport/airport.module.ts",
		"features-airport-airport-module"
	],
...
module.exports = "<app-header></app-header>\n\n<div class=\"container-fluid\" id=\"routerOutlet\">\n<div [hidden]=\"!loading\">\n    <div id=\"wrap\">\n    <div class=\"loading-indicator\" >\n    <svg viewBox=\"0 0 120 120\" class=\"loading\">\n      <circle class=\"loading-circle loading-base\" r=\"57.32\" cx=\"60\" cy=\"60\"></circle>\n    </svg>\n  </div>\n      <div id=\"globe\">\n        <div id=\"plane\"></div>\n      </div>\n    </div>  \n</div>\n<div [hidden]=\"loading\" class=\"router-output\">\n  <router-outlet></router-outlet>\n</div>\n</div>\n\n<app-footer></app-footer>\n"
    ...
    AppComponent.prototype.ngAfterViewInit = function () {
        ...
        this.router.events
            ...
            if (event instanceof _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationStart"]) {
                ...
                event instanceof _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationCancel"] ||
                event instanceof _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationError"]) {
                _this.loading = false;
            }
        });
    };
...
var Configuration = /** @class */ (function () {
    function Configuration() {
        this.Server = 'https://jsonplaceholder.typicode.com/';
        this.ApiUrl = '';
...
/* harmony import */ var _utilities_http_http_interceptor_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utilities/http/http-interceptor.service */ "./src/app/utilities/http/http-interceptor.service.ts");
/* harmony import */ var _app_route_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app.route.module */ "./src/app/app.route.module.ts");
...
/* harmony import */ var _features_shared_header_header_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./features/shared/header/header.component */ "./src/app/features/shared/header/header.component.ts");
/* harmony import */ var _features_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./features/dashboard/dashboard.component */ "./src/app/features/dashboard/dashboard.component.ts");
/* harmony import */ var _features_shared_footer_footer_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./features/shared/footer/footer.component */ "./src/app/features/shared/footer/footer.component.ts");
...
/* harmony import */ var _angular_material_paginator__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! @angular/material/paginator */ "./node_modules/@angular/material/esm5/paginator.es5.js");
...
/* harmony import */ var _features_test_test_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./features/test/test.component */ "./src/app/features/test/test.component.ts");
/* harmony import */ var ng2_charts_ng2_charts__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ng2-charts/ng2-charts */ "./node_modules/ng2-charts/ng2-charts.js");
/* harmony import */ var ng2_charts_ng2_charts__WEBPACK_IMPORTED_MODULE_42___default = /*#__PURE__*/__webpack_require__.n(ng2_charts_ng2_charts__WEBPACK_IMPORTED_MODULE_42__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _features_shared_header_header_component__WEBPACK_IMPORTED_MODULE_8__["HeaderComponent"],
                _features_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_9__["DashboardComponent"],
                _features_shared_footer_footer_component__WEBPACK_IMPORTED_MODULE_10__["FooterComponent"],
                _features_test_test_component__WEBPACK_IMPORTED_MODULE_41__["TestComponent"]
            ],
            imports: [
                ...
                ng2_charts_ng2_charts__WEBPACK_IMPORTED_MODULE_42__["ChartsModule"],
                _node_modules_angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClientModule"],
                _app_route_module__WEBPACK_IMPORTED_MODULE_5__["AppRouteModule"],
            ...
            providers: [
                _utilities_http_http_interceptor_service__WEBPACK_IMPORTED_MODULE_4__["httpInterceptorProvider"]
            ],
...
/* harmony import */ var _features_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./features/dashboard/dashboard.component */ "./src/app/features/dashboard/dashboard.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
module.exports = " \n  <div id=\"carouselExampleIndicators\" class=\"carousel slide\" data-ride=\"carousel\">\n      <ol class=\"carousel-indicators\">\n        <li data-target=\"#carouselExampleIndicators\" data-slide-to=\"0\" class=\"active\"></li>\n        <li data-target=\"#carouselExampleIndicators\" data-slide-to=\"1\"></li>\n        <li data-target=\"#carouselExampleIndicators\" data-slide-to=\"2\"></li>\n      </ol>\n      <div class=\"carousel-inner\">\n        <div class=\"carousel-item active\">\n          <img class=\"d-block w-100\" src=\"../../../assets/airport1.jpg\" alt=\"First slide\">\n          <div class=\"carousel-caption d-none d-md-block\">\n              <h5>Airport App</h5>\n              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id felis et ipsum bibendum ultrices. Morbi vitae pulvinar         velit. Sed aliquam dictum sapien, id sagittis augue malesuada eu.</p>\n            </div>\n        </div>\n        <div class=\"carousel-item\">\n          <img class=\"d-block w-100\" src=\"../../../assets/airport4.jpg\" alt=\"Second slide\">\n          <div class=\"carousel-caption d-none d-md-block\">\n              <h5>Airport App</h5>\n              <p>Create own traval plan and get notified</p>\n            </div>\n        </div>\n        <div class=\"carousel-item\">\n          <img class=\"d-block w-100\" src=\"../../../assets/airport5.jpg\" alt=\"Third slide\">\n          <div class=\"carousel-caption d-none d-md-block\">\n              <h5>Airport App</h5>\n              <p>Find your needs inside/outside of airport</p>\n            </div>\n        </div>\n      </div>\n      <a class=\"carousel-control-prev\" href=\"#carouselExampleIndicators\" role=\"button\" data-slide=\"prev\">\n        <span class=\"carousel-control-prev-icon\" aria-hidden=\"true\"></span>\n        <span class=\"sr-only\">Previous</span>\n      </a>\n      <a class=\"carousel-control-next\" href=\"#carouselExampleIndicators\" role=\"button\" data-slide=\"next\">\n        <span class=\"carousel-control-next-icon\" aria-hidden=\"true\"></span>\n        <span class=\"sr-only\">Next</span>\n      </a>\n    </div>\n  "
...
module.exports = ".carousel-caption h5 {\n  font-size: 24px;\n  margin-bottom: 20px;\n}\n"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./dashboard.component.less */ "./src/app/features/dashboard/dashboard.component.less")]
        }),
...
/***/ "./src/app/features/shared/footer/footer.component.html":
/*!**************************************************************!*\
  !*** ./src/app/features/shared/footer/footer.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = "<footer class=\"footer container-fluid\">\n  <div class=\"bottom\">\n    <div class=\"container\">\n      <div class=\"row\">\n\n        <div class=\"col-lg-6 col-xs-12 text-lg-left text-center\">\n          <span class=\"copyright-text pacifico\">\n            © Airport App\n          </span> |\n          <span class=\"credits\">\n            Developed by\n            <a href=\"https://stackoverflow.com/users/8219012/hornet\">My name</a>\n          </span>\n        </div>\n\n        <div class=\"col-lg-6 col-xs-12 text-lg-right text-center\">\n          <ul class=\"list-inline\">\n            <li class=\"list-inline-item\">\n              <a [routerLink]=\"[]\">\n                <i aria=\"{:hidden=>&quot;true&quot;}\" class=\"fa fa-facebook-square\"></i>\n              </a>\n            </li>\n\n            <li class=\"list-inline-item\">\n              <a [routerLink]=\"[]\">\n                <i aria=\"{:hidden=>&quot;true&quot;}\" class=\"fa fa-twitter\"></i>\n              </a>\n            </li>\n\n            <li class=\"list-inline-item\">\n              <a [routerLink]=\"[]\">\n                <i aria=\"{:hidden=>&quot;true&quot;}\" class=\"fa fa-google-plus\"></i>\n              </a>\n            </li>\n\n            <li class=\"list-inline-item\">\n              <a [routerLink]=\"[]\">\n                <i aria=\"{:hidden=>&quot;true&quot;}\" class=\"fa fa-instagram\"></i>\n              </a>\n            </li>\n\n            <li class=\"list-inline-item\">\n              <a [routerLink]=\"[]\">\n                <i aria=\"{:hidden=>&quot;true&quot;}\" class=\"fa fa-linkedin-square\"></i>\n              </a>\n            </li>\n          </ul>\n        </div>\n\n      </div>\n    </div>\n  </div>\n</footer>"

/***/ }),

/***/ "./src/app/features/shared/footer/footer.component.less":
/*!**************************************************************!*\
  !*** ./src/app/features/shared/footer/footer.component.less ***!
  \**************************************************************/
/*! no static exports found */
...
var FooterComponent = /** @class */ (function () {
    ...
    FooterComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-footer',
            template: __webpack_require__(/*! ./footer.component.html */ "./src/app/features/shared/footer/footer.component.html"),
            styles: [__webpack_require__(/*! ./footer.component.less */ "./src/app/features/shared/footer/footer.component.less")]
        }),
        __metadata("design:paramtypes", [])
    ], FooterComponent);
...
/***/ "./src/app/features/shared/header/header.component.html":
/*!**************************************************************!*\
  !*** ./src/app/features/shared/header/header.component.html ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = "<nav class=\"navbar navbar-expand navbar-light fixed-top\" style=\"background-color:#039be5\">\n    <a class=\"navbar-brand pacifico text-white\" routerLink=\"/\">\n        <span class=\"logo\">✈️</span>\n         <span class=\"d-none d-md-inline brand\">\n            <span>A</span>\n            <span>i</span>\n            <span>r</span>\n            <span>p</span>\n            <span>o</span>\n            <span>r</span>\n            <span>t</span>\n            <span>&nbsp;</span>\n            <span>A</span>\n            <span>p</span>\n            <span>p</span>\n        </span>\n    </a>\n    <div class=\"navbar-collapse collapse justify-content-center\" id=\"navbar5\">\n        <input type=\"text\" class=\"form-control search-box w-50 mr-5\" placeholder=\"Search Airport\"  [matAutocomplete]=\"auto\" [formControl]=\"myControl\">\n        <mat-autocomplete #auto=\"matAutocomplete\">\n            <mat-option *ngFor=\"let option of filteredOptions | async\" [value]=\"option\" (onSelectionChange)=\"gotoAirport($event)\">\n                <mat-toolbar>\n                    <img class=\"example-option-img\" aria-hidden src=\"../../../../assets/logo.png\" height=\"30\">\n                    <small> {{option}} </small>\n                    \n                </mat-toolbar>\n            </mat-option>\n        </mat-autocomplete>\n        \n    </div>\n    <span class=\"navbar-text small text-truncate mt-1 text-right order-1 order-md-last\">\n        <a class=\"nav-link\" id=\"userDetails\" data-target=\"#\" mat-icon-button routerLink=\".\" data-toggle=\"dropdown\" aria-haspopup=\"true\"\n            aria-expanded=\"false\">\n            <i class=\"material-icons\">\n                more_vert\n            </i>\n        </a>\n        <ul class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"userDetails\">\n            <li [routerLinkActive]=\"['active']\">\n                <a class=\"dropdown-item\" [routerLink]=\"['user']\">\n                    <i class=\"material-icons\">\n                        perm_contact_calendar\n                    </i> &nbsp;Profile\n                </a>\n                <div class=\"dropdown-divider\"></div>\n            </li>\n            <li [routerLinkActive]=\"['active']\">\n                <a class=\"dropdown-item\" [routerLink]=\"[]\" (click)=\"ngxSmartModalService.getModal('myModal').open()\">\n                    <i class=\"material-icons\">\n                        vpn_key\n                    </i> &nbsp;Login\n                </a>\n                <div class=\"dropdown-divider\"></div>\n            </li>\n            <li [routerLinkActive]=\"['active']\">\n                <a class=\"dropdown-item\" [routerLink]=\"['']\">\n                    <i class=\"material-icons text-danger\">\n                        power_settings_new\n                    </i> &nbsp;Logout\n                </a>\n            </li>\n        </ul>\n    </span>\n</nav>\n\n<ngx-smart-modal #myModal identifier=\"myModal\" >\n      <div class=\"parentcontainer\">\n        <form class=\"authendication\">\n                <input checked id='signin' name='action' type='radio' value='signin'>\n                <label for='signin'>Sign in</label>\n                <input id='signup' name='action' type='radio' value='signup'>\n                <label for='signup'>Sign up</label>\n                <input id='reset' name='action' type='radio' value='reset'>\n                <label for='reset'>Reset</label>\n                <div id='wrapper'>\n                  <div id='arrow'></div>\n                  <input id='email' placeholder='Email' type='text'>\n                  <input id='pass' placeholder='Password' type='password'>\n                  <input id='repass' placeholder='Repeat password' type='password'>\n                </div>\n                <button type='submit'>\n                  <span>\n                    Reset password\n                    <br>\n                    Sign in\n                    <br>\n                    Sign up\n                  </span>\n                </button>\n              </form>\n  \n</div>\n      </ngx-smart-modal>"

/***/ }),

/***/ "./src/app/features/shared/header/header.component.less":
/*!**************************************************************!*\
  !*** ./src/app/features/shared/header/header.component.less ***!
  \**************************************************************/
/*! no static exports found */
...
module.exports = ".navbar {\n  box-shadow: 0 3px 5px -1px rgba(0, 0, 0, 0.2), 0 6px 10px 0 rgba(0, 0, 0, 0.14), 0 1px 18px 0 rgba(0, 0, 0, 0.12);\n}\n.dropdown-menu-right {\n  right: 0;\n  left: auto;\n}\n.logo {\n  display: inline-block;\n  width: 20px;\n  height: 20px;\n  margin-top: 7px;\n  -webkit-transform: rotateZ(-90deg);\n          transform: rotateZ(-90deg);\n}\n.show > .dropdown-menu {\n  -webkit-transform: scale(1, 1);\n  transform: scale(1, 1);\n}\n.dropdown-menu {\n  -webkit-transform-origin: top;\n  transform-origin: top;\n  -webkit-animation-fill-mode: forwards;\n  animation-fill-mode: forwards;\n  -webkit-transform: scale(1, 0);\n          transform: scale(1, 0);\n  display: block;\n  transition: all 0.2s ease-out;\n  -webkit-transition: all 0.2s ease-out;\n}\n.search-box {\n  background: white;\n  padding: 11px;\n  border-radius: 3px;\n}\n.search-selected {\n  background: rgba(0, 0, 0, 0.05);\n  padding: 11px;\n  border-radius: 3px;\n  color: white;\n  text-align: center;\n}\n.brand {\n  height: 60px;\n  margin-left: 12px;\n}\n.brand span {\n  position: relative;\n  top: 0px;\n  display: inline-block;\n  -webkit-animation: bounce 1.3s ease infinite alternate;\n          animation: bounce 1.3s ease infinite alternate;\n  font-family: 'Titan One', cursive;\n  font-size: 24px;\n  color: #FFF;\n  text-shadow: 0 1px 0 #CCC, 0 2px 0 #CCC, 0 3px 0 #c2c2c2, 0 6px 0 transparent, 0 7px 0 transparent, 0 8px 0 transparent, 0 9px 0 transparent, 0 10px 10px rgba(0, 0, 0, 0.4);\n}\n.brand span:nth-child(2) {\n  -webkit-animation-delay: 0.1s;\n          animation-delay: 0.1s;\n}\n.brand span:nth-child(3) {\n  -webkit-animation-delay: 0.2s;\n          animation-delay: 0.2s;\n}\n.brand span:nth-child(4) {\n  -webkit-animation-delay: 0.3s;\n          animation-delay: 0.3s;\n}\n.brand span:nth-child(5) {\n  -webkit-animation-delay: 0.4s;\n          animation-delay: 0.4s;\n}\n.brand span:nth-child(6) {\n  -webkit-animation-delay: 0.5s;\n          animation-delay: 0.5s;\n}\n.brand span:nth-child(7) {\n  -webkit-animation-delay: 0.6s;\n          animation-delay: 0.6s;\n}\n.brand span:nth-child(8) {\n  -webkit-animation-delay: 0.7s;\n          animation-delay: 0.7s;\n}\n.brand span:nth-child(9) {\n  -webkit-animation-delay: 0.8s;\n          animation-delay: 0.8s;\n}\n.brand span:nth-child(10) {\n  -webkit-animation-delay: 0.9s;\n          animation-delay: 0.9s;\n}\n.brand span:nth-child(11) {\n  -webkit-animation-delay: 0.1s;\n          animation-delay: 0.1s;\n}\n.brand span:nth-child(12) {\n  -webkit-animation-delay: 0.11s;\n          animation-delay: 0.11s;\n}\n@-webkit-keyframes bounce {\n  100% {\n    text-shadow: 0 1px 0 #CCC, 0 2px 0 #CCC, 0 25px 25px rgba(0, 0, 0, 0.7);\n  }\n}\n@keyframes bounce {\n  100% {\n    text-shadow: 0 1px 0 #CCC, 0 2px 0 #CCC, 0 25px 25px rgba(0, 0, 0, 0.7);\n  }\n}\n/* sign up */\n.authendication #wrapper,\n.authendication label,\n.authendication #arrow,\n.authendication button span {\n  transition: all 0.5s cubic-bezier(0.6, 0, 0.4, 1);\n}\n.authendication #wrapper {\n  overflow: hidden;\n}\n.authendication #signin:checked ~ #wrapper {\n  height: 174px;\n}\n.authendication #signin:checked ~ #wrapper #arrow {\n  left: 32px;\n}\n.authendication #signin:checked ~ button span {\n  -webkit-transform: translate3d(0, -72px, 0);\n          transform: translate3d(0, -72px, 0);\n}\n.authendication #signup:checked ~ #wrapper {\n  height: 262px;\n}\n.authendication #signup:checked ~ #wrapper #arrow {\n  left: 137px;\n}\n.authendication #signup:checked ~ button span {\n  -webkit-transform: translate3d(0, -144px, 0);\n          transform: translate3d(0, -144px, 0);\n}\n.authendication #reset:checked ~ #wrapper {\n  height: 94px;\n}\n.authendication #reset:checked ~ #wrapper #arrow {\n  left: 404px;\n}\n.authendication #reset:checked ~ button span {\n  -webkit-transform: translate3d(0, 0, 0);\n          transform: translate3d(0, 0, 0);\n}\nform.authendication {\n  width: 450px;\n  height: 420px;\n  margin: -205px -225px;\n  position: absolute;\n  left: 50%;\n  top: 50%;\n  padding: 25px;\n  background: #30baff;\n}\n.parentcontainer {\n  height: 410px;\n  padding: 10px;\n}\n.authendication input[type=radio] {\n  display: none;\n}\n.authendication label {\n  cursor: pointer;\n  display: inline-block;\n  font-size: 22px;\n  font-weight: 800;\n  opacity: 0.5;\n  margin-bottom: 30px;\n  text-transform: uppercase;\n}\n.authendication label:hover {\n  transition: all 0.3s cubic-bezier(0.6, 0, 0.4, 1);\n  opacity: 1;\n}\n.authendication label[for=\"signin\"] {\n  margin-right: 20px;\n}\n.authendication label[for=\"reset\"] {\n  float: right;\n}\n.authendication input[type=radio]:checked + label {\n  opacity: 1;\n}\n.authendication input[type=text],\n.authendication input[type=password] {\n  background: #fff;\n  border: none;\n  border-radius: 8px;\n  font-size: 27px;\n  font-family: 'Raleway', sans-serif;\n  height: 72px;\n  width: 99.5%;\n  margin-bottom: 10px;\n  opacity: 1;\n  text-indent: 20px;\n  transition: all 0.2s ease-in-out;\n}\n.authendication button {\n  background: #079BCF;\n  border: none;\n  border-radius: 8px;\n  color: #fff;\n  cursor: pointer;\n  font-family: 'Raleway', sans-serif;\n  font-size: 27px;\n  height: 72px;\n  width: 100%;\n  margin-bottom: 10px;\n  overflow: hidden;\n  transition: all 0.3s cubic-bezier(0.6, 0, 0.4, 1);\n}\n.authendication button span {\n  display: block;\n  line-height: 72px;\n  position: relative;\n  top: -2px;\n  -webkit-transform: translate3d(0, 0, 0);\n          transform: translate3d(0, 0, 0);\n}\n.authendication button:hover {\n  background: #007BA5;\n}\n.authendication #arrow {\n  height: 0;\n  width: 0;\n  border-bottom: 10px solid #fff;\n  border-left: 10px solid transparent;\n  border-right: 10px solid transparent;\n  position: relative;\n  left: 32px;\n}\n.authendication #hint {\n  width: 100%;\n  text-align: center;\n  position: absolute;\n  bottom: 20px;\n}\n/* sign up */\n"
...
/* harmony import */ var _node_modules_ngx_smart_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../node_modules/ngx-smart-modal */ "./node_modules/ngx-smart-modal/esm5/ngx-smart-modal.js");
/* harmony import */ var _utilities_http_http_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../utilities/http/http.service */ "./src/app/utilities/http/http.service.ts");
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(httpservice, ngxSmartModalService, router) {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.filteredOptions = this.myControl.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (value) { return _this._filter(value); }));
    };
    ...
    HeaderComponent.prototype.gotoAirport = function (e) {
        this.router.navigate(['airport']);
    };
    HeaderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-header',
            template: __webpack_require__(/*! ./header.component.html */ "./src/app/features/shared/header/header.component.html"),
            styles: [__webpack_require__(/*! ./header.component.less */ "./src/app/features/shared/header/header.component.less")]
        }),
        __metadata("design:paramtypes", [_utilities_http_http_service__WEBPACK_IMPORTED_MODULE_4__["HttpService"],
            _node_modules_ngx_smart_modal__WEBPACK_IMPORTED_MODULE_3__["NgxSmartModalService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])
    ], HeaderComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _utilities_http_http_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utilities/http/http.service */ "./src/app/utilities/http/http.service.ts");
/* harmony import */ var _node_modules_ngx_smart_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../node_modules/ngx-smart-modal */ "./node_modules/ngx-smart-modal/esm5/ngx-smart-modal.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TestComponent = /** @class */ (function () {
    function TestComponent(httpservice, ngxSmartModalService) {
        this.httpservice = httpservice;
        this.ngxSmartModalService = ngxSmartModalService;
    }
    ...
    TestComponent.prototype.getTest = function () {
        this.httpservice.read('posts/').subscribe(function (data) { return console.log(data); });
    };
    TestComponent.prototype.postTest = function () {
    ...
    TestComponent.prototype.putTest = function () {
    ...
    TestComponent.prototype.deletTest = function () {
        this.httpservice.delete('posts/2').subscribe(function (data) { return console.log(data); });
    };
    TestComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-test',
            template: __webpack_require__(/*! ./test.component.html */ "./src/app/features/test/test.component.html"),
            styles: [__webpack_require__(/*! ./test.component.less */ "./src/app/features/test/test.component.less")]
        }),
        __metadata("design:paramtypes", [_utilities_http_http_service__WEBPACK_IMPORTED_MODULE_1__["HttpService"],
            _node_modules_ngx_smart_modal__WEBPACK_IMPORTED_MODULE_2__["NgxSmartModalService"]])
    ], TestComponent);
...
/***/ "./src/app/utilities/http/http-interceptor.service.ts":
/*!************************************************************!*\
  !*** ./src/app/utilities/http/http-interceptor.service.ts ***!
  \************************************************************/
/*! exports provided: HttpInterceptorService, httpInterceptorProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/app/utilities/http/http.service.ts":
/*!************************************************!*\
  !*** ./src/app/utilities/http/http.service.ts ***!
  \************************************************/
...
var HttpService = /** @class */ (function () {
    function HttpService(httpClient, config) {
        this.httpClient = httpClient;
        this.config = config;
    }
    HttpService.prototype.create = function (endpointUrl, body) {
        return this.httpPost(endpointUrl, body);
    };
    HttpService.prototype.update = function (url, body) {
        return this.httpPut(url, body);
    };
    HttpService.prototype.read = function (urlEndPoint, queryOptions) {
        return this.httpGet(urlEndPoint, queryOptions);
    };
    HttpService.prototype.delete = function (endpointUrl) {
        return this.httpDelete(endpointUrl);
    };
    HttpService.prototype.httpGet = function (endpointUrl, params) {
        console.log(this.getApiUrl(endpointUrl));
        return this.httpClient.get(this.getApiUrl(endpointUrl), { observe: 'response' });
    };
    HttpService.prototype.httpPost = function (endpointUrl, body) {
        return this.httpClient.post(this.getApiUrl(endpointUrl), body, { observe: 'response' });
    };
    HttpService.prototype.httpPut = function (endpointUrl, body) {
        return this.httpClient.put(this.getApiUrl(endpointUrl), body, { observe: 'response' });
    };
    HttpService.prototype.httpDelete = function (endpointUrl, id) {
        return this.httpClient.delete(this.getApiUrl(endpointUrl), { observe: 'response' });
    };
    HttpService.prototype.getApiUrl = function (endpointUrl) {
    ...
    HttpService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
            _app_config__WEBPACK_IMPORTED_MODULE_2__["Configuration"]])
    ], HttpService);
    return HttpService;
}());
...
module.exports = __webpack_require__(/*! C:\AirportHelpDesk\src\main.ts */"./src/main.ts");
